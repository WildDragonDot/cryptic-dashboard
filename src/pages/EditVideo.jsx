...
const Uploader = () => {
  ...
  const videoData = async () => {
    try {
      ...
      result.data.map((item) => {
        if (item.video_uuid === param.id) {
          setVideoTitle(item.name);
          setVideoCategory(item.module_uuid);
          setDescription(item.video_desc);
          setImageFileName(item.name + ".jpg");
          setVideoFileName(item.name + ".mp4");
          setVideoUploading(false);
          setImageUrl(item.thumbnail_ipfs);
          setVideoUrl(item.video_uid);
        }
      });
    } catch (error) {
      console.log(error);
  ...
  async function handleFileUpload() {
    ...
    if (videoTitle === "" || videoCategory === "" || description === "") {
      swal({
        title: "Warning!",
    ...
    } else if (videoFile.name !== undefined && imageFile.name !== undefined) {
      ...
      reader.onloadend = async () => {
        ...
        try {
          ...
          videoUrl = `https://${IpfsCid}.ipfs.w3s.link/${fileName}`;
        ...
        async function imageUpload(videoUrl) {
          try {
            ...
            reader.onloadend = async () => {
              ...
              data.append("video_uuid", param.id);
              ...
              data.append("user_address", accountAddress);
              data.append("user_type", "admin");

              var config = {
                method: "post",
                url: `${process.env.REACT_APP_LOCALHOST_URL}/php/API/update_video`,
                data: data,
              };
              axios(config)
                .then(function (response) {
                  ...
                  swal({
                    ...
                    navigate(`/videodetails/${param.id}`);
                  });
                })
    ...
    } else if (videoFile.name !== undefined) {
      let videoUrl = "";
      var FormData = require("form-data");
      var data = new FormData();
      setVideoUploading(true);
    ...
    <div className="m-2 md:m-10 mt-24 p-2 md:p-10 rounded-3xl">
      ...
      <div className="container max-w-2xl mx-auto flex-1 flex flex-col items-center justify-center px-2">
        ...
        >
          ...
          <div className="flex items-center justify-center" id="select">
              ...
              >
                <div className="mb-5">
                  ...
                  >
                    ...
                    <option value="927f0965-6eed-462c-bfa0-79867c9f9448" {...videoCategory === '927f0965-6eed-462c-bfa0-79867c9f9448'?'selected':''}>Explainers</option>
                    <option value="fd3d24bd-8764-494e-9ade-40911b8e11a1" {...videoCategory === 'fd3d24bd-8764-494e-9ade-40911b8e11a1'?'selected':''}>Tutorials</option>
                    <option value="5dae4ba7-933a-40a9-8866-49ee971ccf87" {...videoCategory === '5dae4ba7-933a-40a9-8866-49ee971ccf87'?'selected':''}>Review</option>
                    <option value="5822014a-02af-41c4-8564-0ec4ceba8db6" {...videoCategory === '5822014a-02af-41c4-8564-0ec4ceba8db6'?'selected':''}>News</option>
                    <option value="0f01d804-648d-42a7-ab11-bdc373f4b7bd" {...videoCategory === '0f01d804-648d-42a7-ab11-bdc373f4b7bd'?'selected':''}>Others</option>
                  </select>
                </div>
                      ...
                      <div id="image">
                        ...
                        <div className="col-md-12">
                          <div className="form-group">
                            ...
                            <div className="drop-zone" style={{height: "300px"}}>
                              <span className="drop-zone__prompt" style={{display : "none"}}>
                              ...
                              <input
                                ...
                                accept="image/*"
                              />
                              <div className="drop-zone__thumb" style={{backgroundImage : `url(${ImageUrl})`}} data-label={`${imageFileName}`}></div>
                            </div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="form-group">
                            ...
                            <div className="drop-zone" style={{height : "300px"}}>
                              ...
                              <input
                                ...
                                accept="video/*"
                              />
                              <div className="drop-zone__thumb" style={{backgroundImage : `url(${ImageUrl})`}} data-label={`${videoFileName}`}></div>
                            </div>
                            <span
                              className="my-1"
                ...
                <div>
                  {!videoUploading ? (
                    ...
                    imageFile ? (
                      ...
                      <button
                        type="button"
                        className="hover:shadow-form w-full rounded-md  py-3 px-8 text-center text-base font-semibold text-white outline-none transition ease-in-out duration-150"
                        onClick={handleFileUpload}
                        style={{ background: currentColor }}
                      >
                        Send File
