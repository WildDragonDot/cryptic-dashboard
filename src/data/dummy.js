...
import { FaDonate,FaPhotoVideo } from "react-icons/fa";
import { IoMdContacts } from 'react-icons/io';
import { RiDashboardFill, RiStockLine,RiVideoUploadLine } from 'react-icons/ri';
import { MdOutlineSupervisorAccount , MdVideoLibrary, MdAttachMoney, MdEmojiPeople} from 'react-icons/md';
...
export const gridOrderImage = (props) => (
  <div>
    <img
      ...
      src={props.thumbnail_ipfs.split('.ipfs.w3s.link')[0] + '.ipfs.w3s.link' + props.thumbnail_ipfs.split('.ipfs.w3s.link')[1]} 
      alt="order-item"
    />
  </div>
);
...
export const gridOrderLink = (props) => (
  <div>
    <a
     className="text-truncate overflow-hidden w-50"
      href={props.link}
      alt="link"
      target="_blank"
    >Play Now</a>
...
export const gridMoreDetails = (props) => (
  <div>
    <Link
     className="text-truncate overflow-hidden w-50"
      to={props.moreDetails}
      alt="link"
    >More Details</Link>
  </div>
);

export const gridTxnLink = (props) => (
  <div>
    <a
     className="text-truncate overflow-hidden w-50"
      href={props.txn_link}
...
export const donerGrid = [
  ...
  {
    headerText: 'Sender',
    field: 'from_user_address',
    textAlign: 'Center',
    width: '120',
  },
  {
    field: 'to_user_address',
    headerText: 'Reciever',
    width: '120',
    textAlign: 'Center',
  },
  ...
  {
    template: gridTxnLink,
    headerText: 'Transation Link',
    width: '150',
    textAlign: 'Center',
  },
  {
